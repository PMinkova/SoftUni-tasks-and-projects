namespace NavalVessels.Models
{
    ...
    {
        private string name; // add private field if you have a validation
        private ICaptain captain;

        // protected when abstract class
        ...
        public string Name
        {
            get
            {
                return this.name; // Always use the fields in the property - small letters!
            }
            private set // it should be private!
            {
                if (string.IsNullOrWhiteSpace(value))  // It includes Null, Empty and White spaces
                {
        ...
        public override string ToString()
        {
            ...
            var targetsOutput = this.Targets.Any() ? String.Join(", ", this.Targets) : "None";
