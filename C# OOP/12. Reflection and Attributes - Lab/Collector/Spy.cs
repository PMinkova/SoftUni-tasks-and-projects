namespace Stealer
{
    ...
    public class Spy
    {
        ...
        {
            var classType = Type.GetType(className);
            var allMethods = classType.GetMethods(BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static);

            var sb = new StringBuilder();

            sb
                .AppendLine($"All Private Methods of Class: {classType.Name}")
        ...
        public string CollectGettersAndSetters(string className)
        {
            ...
            var methods = classType.GetMethods(BindingFlags.Instance | BindingFlags.CreateInstance |
